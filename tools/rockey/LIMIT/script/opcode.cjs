 ...
 *! 用法: node tools/rockey/LIMIT/script/opcode.cjs [--dry-run]
 */
...
const lines = [
  "/**",
  " *! AUTO-GENERATED from Interface/script.h (enum class OpCode) by tools/rockey/LIMIT/script/opcode.cjs. 请勿手工编辑.",
  " *! 修改请改 script.h 后运行: node tools/rockey/LIMIT/script/opcode.cjs (或 make jsWrapper)",
  " */",
