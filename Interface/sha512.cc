...
Sha512Ctx& Sha512Ctx::Update(const void* input, size_t size) {
  rlCryptoSha512CtxUpdate(&ctx_, input, (int)size);
  return *this;
}
Sha512Ctx& Sha512Ctx::Final(uint8_t md[64]) {
  rlCryptoSha512CtxFinal(&ctx_, md);
  return *this;
}
#else /* __RockeyARM__ */
 ...
 * Round constants
 */
#define SHA512_K_I(XX, a0, a1, a2, a3, a4, a5, a6, a7) \
  struct SHA512_K__##XX {                              \
...
SHA512_K_I(0,
           ...
           UL64(0xB5C0FBCFEC4D3B2F),
           UL64(0xE9B5DBA58189DBBC),
           UL64(0x3956C25BF348B538),
           UL64(0x59F111F1B605D019),
           UL64(0x923F82A4AF194F9B),
           UL64(0xAB1C5ED5DA6D8118));

SHA512_K_I(1,
           UL64(0xD807AA98A3030242),
           UL64(0x12835B0145706FBE),
           UL64(0x243185BE4EE4B28C),
           UL64(0x550C7DC3D5FFB4E2),
           UL64(0x72BE5D74F27B896F),
           UL64(0x80DEB1FE3B1696B1),
           UL64(0x9BDC06A725C71235),
...
SHA512_K_I(2,
           ...
           UL64(0x0FC19DC68B8CD5B5),
           UL64(0x240CA1CC77AC9C65),
           UL64(0x2DE92C6F592B0275),
           UL64(0x4A7484AA6EA6E483),
           UL64(0x5CB0A9DCBD41FBD4),
           UL64(0x76F988DA831153B5));

SHA512_K_I(3,
           UL64(0x983E5152EE66DFAB),
           UL64(0xA831C66D2DB43210),
           UL64(0xB00327C898FB213F),
           UL64(0xBF597FC7BEEF0EE4),
           UL64(0xC6E00BF33DA88FC2),
           UL64(0xD5A79147930AA725),
           UL64(0x06CA6351E003826F),
           UL64(0x142929670A0E6E70));

SHA512_K_I(4,
           UL64(0x27B70A8546D22FFC),
           UL64(0x2E1B21385C26C926),
           UL64(0x4D2C6DFC5AC42AED),
           UL64(0x53380D139D95B3DF),
           UL64(0x650A73548BAF63DE),
           UL64(0x766A0ABB3C77B2A8),
           UL64(0x81C2C92E47EDAEE6),
           UL64(0x92722C851482353B));

SHA512_K_I(5,
           UL64(0xA2BFE8A14CF10364),
           UL64(0xA81A664BBC423001),
           UL64(0xC24B8B70D0F89791),
           UL64(0xC76C51A30654BE30),
           UL64(0xD192E819D6EF5218),
           UL64(0xD69906245565A910),
           UL64(0xF40E35855771202A),
           UL64(0x106AA07032BBD1B8));

SHA512_K_I(6,
           UL64(0x19A4C116B8D2D0C8),
           UL64(0x1E376C085141AB53),
           UL64(0x2748774CDF8EEB99),
           UL64(0x34B0BCB5E19B48A8),
           UL64(0x391C0CB3C5C95A63),
           UL64(0x4ED8AA4AE3418ACB),
           UL64(0x5B9CCA4F7763E373),
...
SHA512_K_I(7,
           ...
           UL64(0xBEF9A3F7B2C67915),
           UL64(0xC67178F2E372532B));

SHA512_K_I(8,
           UL64(0xCA273ECEEA26619C),
           UL64(0xD186B8C721C0C207),
           UL64(0xEADA7DD6CDE0EB1E),
           UL64(0xF57D4F7FEE6ED178),
           UL64(0x06F067AA72176FBA),
           UL64(0x0A637DC5A2C898A6),
           UL64(0x113F9804BEF90DAE),
           UL64(0x1B710B35131C471B));

SHA512_K_I(9,
           UL64(0x28DB77F523047D84),
           UL64(0x32CAAB7B40C72493),
           UL64(0x3C9EBE0A15C9BEBC),
           UL64(0x431D67C49C100D4C),
           UL64(0x4CC5D4BECB3E42B6),
           UL64(0x597F299CFC657E2A),
           UL64(0x5FCB6FAB3AD6FAEC),
           UL64(0x6C44198C4A475817));

struct SHA512_K {
  uint64_t operator[](size_t i) const {
    size_t index = i >> 3, entry = i & 7;
    if (index >= 5) {
      if (index == 5)
        return SHA512_K__5().Get(entry);
      if (index == 6)
        return SHA512_K__6().Get(entry);
      if (index == 7)
        return SHA512_K__7().Get(entry);
      if (index == 8)
        return SHA512_K__8().Get(entry);
      return SHA512_K__9().Get(entry);
    } else {
      if (index == 0)
        return SHA512_K__0().Get(entry);
      if (index == 1)
        return SHA512_K__1().Get(entry);
      if (index == 2)
        return SHA512_K__2().Get(entry);
      if (index == 3)
        return SHA512_K__3().Get(entry);
      return SHA512_K__4().Get(entry);
    }
  }
} K;
...
Sha512Ctx& Sha512Ctx::Final(uint8_t md[64]) {
  internal_sha512_final((SHA512_CTX*)&ctx_, md, 0);
  return *this;
}
#endif /* __RockeyARM__ */
